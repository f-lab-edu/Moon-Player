...
const MusicPageHeaderItems = () => {
  ...
  return (
    <MusicHeaderContentLayout>
      ...
      <MusicHeaderItemBox>
        <MusicHeaderItem><Link to='/search'><FontAwesomeIcon icon={faMagnifyingGlass} /></Link></MusicHeaderItem>
        <MusicHeaderItem>검색</MusicHeaderItem>
      </MusicHeaderItemBox>
      <MusicHeaderItemBox>
        <MusicHeaderItem><Link to='/user'><FontAwesomeIcon icon={faUser} /></Link></MusicHeaderItem>
